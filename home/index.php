            ...
            <a href="#">
               <div class="box ">
                  ...
                  <div class="detail-box">
                     ...
                     <p>
                        Varieties of Labtops available
                     </p>
                  </div>
               </div>
            </a>
            ...
            <a href="#">
               <div class="box ">
                  ...
                  <div class="detail-box">
                     ...
                     <p>
                        Varieties of Mobiles available
                     </p>
                  </div>
               </div>
            </a>
...
<section class="product_section layout_padding">
   <div class="container">
      ...
      <div class="row">
         ...
         $execute_sql = mysqli_query($conn, $select_pro);
         while ($db_products = mysqli_fetch_assoc($execute_sql)) {
            $product_id = $db_products['id'];
            // echo $product_id;
            $product_name = $db_products['p_name'];
            $product_price = $db_products['p_price'];
            $product_image = $db_products['p_image'];
            ...
            <div class="col-sm-6 col-md-4 col-lg-4">
               ...
               <div class="box">
                  <div class="option_container">
                     <div class="options">
                        <a href="detaile.php?id=<?php echo $product_id; ?>" class="option1">
                           Product Details
                        </a>
                        <?php
                        if (isset($_SESSION['u_id'])) {
                           $selec_catr = "SELECT * FROM cart WHERE product_id = '" . $product_id . "' AND `user_id` = '" . $_SESSION['u_id'] . "'";
                           $exe_select_car = mysqli_query($conn, $selec_catr);
                           if (mysqli_num_rows($exe_select_car) > 0) {
                              ?>
                              <a href="add_cart.php?del_id=<?php echo $product_id; ?>" class="option2" style="font-size: 14px;">
                                 Remove From Cart
                              </a>
                              <?php
                           } else {
                              ?>
                              <a href="add_cart.php?id=<?php echo $product_id; ?>" class="option2">
                                 Add to Cart
                              </a>
                              <?php
                           }
                  ...
                  <div class="img-box">
                     <img src='images/<?php echo $db_products['p_image']; ?>'>
