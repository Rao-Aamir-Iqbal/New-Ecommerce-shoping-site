...
$limit = 10;
$total_count = "SELECT count(id) as total_data FROM products";
$total_execute = mysqli_query($conn, $total_count);
$total_row = mysqli_fetch_assoc($total_execute);

$total_result = $total_row['total_data'];

$totql_pages = ciel($total_result/$limit);
